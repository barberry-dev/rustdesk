...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, Barberry Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Barberry Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Barberry Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Barberry Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Barberry Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Barberry Remote Input] service."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Barberry Remote."),
        ...
        ("verify_rustdesk_password_tip", "Verify Barberry Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Barberry Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Barberry Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Barberry Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Barberry Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep Barberry Remote background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Barberry Remote client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Barberry Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, Barberry Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Barberry Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Barberry Remote server OSS doesn't include this feature."),
